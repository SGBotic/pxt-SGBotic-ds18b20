...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 1360 (incl. 760 user, 540 helpers, 12 vtables, 48 lits); src size 0
; assembly: 936 lines; density: 190 bytes/stmt; (4 stmts)
; total bytes: 217424 (89.6% of 237.0k flash with 25264 free)
; peep hole pass: 19 instructions removed and 19 updated
...
; start
    ...
    .hex 05EF42607609DEA9 ; hex template hash
    .hex 285B2FE23B75A0D3 ; program hash
    .short 4   ; num. globals
...
_img0:
 .short 0xffff
        .short 5, 5
        .byte 0,0,255,0,0,0,0,255,0,0,0,0,255,0,0,0,0,255,0,0,0,0,255,0,0,0
.balign 4
_str1meta:
